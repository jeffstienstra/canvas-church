...
import {FaTimes, FaEnvelope, FaBookOpen, FaBookMedical, FaBook, FaAddressBook, FaChevronDown, FaBars} from 'react-icons/fa'
...
const about = [
    ...
    },
    {
        ...
        description: 'All the world is made of faith, and trust, and pixie dust. ~J.M. Barrie, Peter Pan',
        href: '/about',
        icon: FaBookMedical,
    },
    ]
...
const media = [
    {
        name: 'Sermons',
        description: 'Listen to past Sundays gone by',
        href: '/media',
        icon: FaBook,
    },
    {
    ...
    {
        name: 'Resources',
        description: 'Find help when you need it',
        href: 'media',
        icon: FaBookMedical,
    },
]
...
const community = [
    {
        name: 'Kids',
        description: 'Listen to Sundays gone by',
        href: '/community',
        icon: FaBook,
    },
    {
        name: 'Small Groups',
        description: 'Gather together in a low stress, low key, lo-fi kinda way',
        href: '/community',
        icon: FaAddressBook,
    },
    {
        name: 'Events',
        description: 'Get connected with our community partners',
        href: '/community',
        icon: FaBookMedical,
    },
    {
...
const callsToAction = [
{ name: "Have Questions? We're all ears.", href: '/contact', icon: FaEnvelope },
// { name: 'Contact Sales', href: '#', icon: FaTimes },
]
...
export default function Example() {
    return (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
                ...
                <Popover className="relative">
                    {({ open }) => (
                        ...
                        <Transition
                            ...
                            leaveTo="opacity-0 translate-y-1"
                        >
                            <Popover.Panel className="absolute z-10 -ml-4 mt-3 w-screen max-w-md transform px-2 sm:px-0 lg:left-1/2 lg:ml-0 md:-translate-x-1/2">
                            <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                                <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                {community.map((item) => (
                                    <a
            ...
            {/* replace this with 'About' Popover */}
            {/* <Popover className="relative">
                {({ open }) => (
                    <>
                    <Popover.Button
                    ...
                    >
                        ...
                        <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                            ...
                            <div className="mt-5 text-sm">
                                <a href="#" className="font-medium text-[#4DB1CC] hover:text-[rgb(77,177,204,0.75)]">
                                View all posts
            ...
            <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                ...
                <a href="/signup"
                    className="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-[#4DB1CC] px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-[#D55A1E]"
                >
                Sign up
                </a>
            </div>
            ...
            <div className="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                ...
                {({ open }) => (
                    ...
                    <Transition
                        ...
                        leaveTo="opacity-0 translate-y-1"
                    >
                        <Popover.Panel className="absolute z-10 -ml-7 mt-3 max-w-md transform px-2 sm:left-0 md:left-10% lg:left-1/2 lg:ml-0 lg:-translate-x-1/2">
                        <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                            <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                            {about.map((item) => (
                                <a
